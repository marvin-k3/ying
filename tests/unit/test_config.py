...
class TestStreamConfig:
    ...
    def test_rtsp_url_validation(self) -> None:
        ...
        StreamConfig(name="test", url="rtsp://user:pass@192.168.1.100:554/stream", enabled=True)
...
class TestConfig:
    ...
    def test_window_hop_validation(self, minimal_env: dict[str, str]) -> None:
        ...
        with patch.dict(os.environ, env, clear=True):
            with pytest.raises(ValidationError, match="hop_seconds must be greater than window_seconds"):
                Config()
