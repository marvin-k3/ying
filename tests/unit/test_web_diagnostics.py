...
def mock_config():
    ...
    config.stream_1 = type('StreamConfig', (), {
        'name': 'living_room',
        'url': 'rtsp://test1',
        'enabled': True
    })()
    config.stream_2 = type('StreamConfig', (), {
        'name': 'kitchen',
        'url': 'rtsp://test2',
        'enabled': True
    })()
...
class TestRecognitionsAPI:
    ...
    def test_get_recognitions_success(self, mock_repo_class, client, sample_recognitions):
    ...
    @patch('app.web.routes.RecognitionRepository')
    def test_get_recognitions_with_limit(self, mock_repo_class, client, sample_recognitions):
    ...
    @patch('app.web.routes.RecognitionRepository')
    def test_get_recognitions_with_stream_filter(self, mock_repo_class, client, sample_recognitions):
    ...
    @patch('app.web.routes.RecognitionRepository')
    def test_get_recognitions_with_provider_filter(self, mock_repo_class, client, sample_recognitions):
...
class TestDiagnosticsIntegration:
    ...
    @patch('app.web.routes.RecognitionRepository')
    def test_diagnostics_page_integration(self, mock_repo_class, client, sample_recognitions):
